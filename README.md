# Project 2 - The New York Times App

The New York Times App is an android app that allows a user to search for articles on web using simple filters. The app utilizes [New York Times Search API](http://developer.nytimes.com/docs/read/article_search_api_v2).
...
* [x] Default picture displayed when no image is there

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='http://i.imgur.com/PN4KdGX.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
